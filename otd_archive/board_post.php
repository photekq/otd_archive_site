...
</script><style type="text/css">.highslide img {cursor: url(./highslide/graphics/index.htmlzoomin.cur), pointer !important;}</style></head>
...
<ul class="Gnb-menu">
	...
	<ul class="sub-menu">
		...
		<li class="sub6 last"><a href="">OTD LOTTO</a></li>
					...
					<div id="content">
<style type="text/css">
.sub1 a { color:#3784B7 !important; font-weight:bold !important; 	background:url("./gn/css/bul_sub_menu_on.gif") no-repeat 4px 3px !important;}
</style>
...
<tbody><tr>
    <td height="30" background="./album_post_files/view_dot.gif" style="color:#888;">
        ...
        &nbsp;글쓴이 : 
        <a href="board.php?user_search=<?php echo $author_id;?>" title="[<?php echo $author_id;?>]<?php echo $author_name;?>"><span class="member"><?php echo $author_name;?></span></a>        </div>
        <div style="float:right;">
				...
				<td valign="top">
					<div style="height:28px; background:url(../skin/board/basic_album_aqua/img/co_title_bg.gif); clear:both; line-height:28px;">
						<div style="float:left; margin:2px 0 0 2px;">
							<strong><a href="board.php?user_search='.$comment_author_id.'" title="['.$comment_author_id.']'.$comment_author_name.'"><span class="member">'.$comment_author_name.'</span></a></strong>
